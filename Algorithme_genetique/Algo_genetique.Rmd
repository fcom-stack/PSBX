...
**V- Particularités par rapports aux autres algorithmes**
...
### b. Structure
  ...
  Dans les AG, nous disposons d'un ensemble ou d'une population de solutions possibles au problème donné.Cette population peut être générée au hasard ou générée en utilisant les fonctions heuristiques. Ensuite nous sélectionnons les parents de cette population pour l'accouplement.On applique des opérateurs génétique de sélection, de croisement et ou de mutation sur les parents pour générer de nouveaux rejetons. Finalement, ces descendants remplacent les individus existants dans la population et le processus se répète. De cette façon, les algorithmes génétiques tentent en fait d'imiter l'évolution humaine dans une certaine mesure. 
...
#### Représentation binaire
  ...
  Ce type de représentation, le génotype est constitué de chaînes de bits.Pour certains problèmes, lorsque l'espace de solution est constitué de variables de décision booléennes - oui ou non, la représentation binaire est naturelle.
...
## 2. Initialisation de la population 
  ...
  Il existe deux méthodes principales pour initialiser une population dans une AG. Il s'agit des méthodes suivantes
...
ÉÉvidemment, si α = 0.5, alors les deux enfants seront identiques comme le montre l'image suivante.
